...
export default function Proposal({ active, goTo }) {
  ...
  // REJECT never resolves to a real "no" — it just keeps dodging, forever.
  function handleRejectClick() {
    const attempt = dodgeAttempts + 1;
    setDodgeAttempts(attempt);
    setDodgeMsg(dodgeMessages[(attempt - 1) % dodgeMessages.length]);
    repositionReject();
  }
  ...
  return (
    <Scene active={active}>
      ...
      <p className="proposal-question">Will you be my partner?</p>
